...
bool try_use_gpu = true; //Use GPU power to reduce CPU load
...
int main(int argc, char* argv[])
{
        ...
        //display = imread(result); //Uncommment these 4 lines if you want an window automatally displayed
